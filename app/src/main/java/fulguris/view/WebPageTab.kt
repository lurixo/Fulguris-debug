...
class WebPageTab(
    ...
    private fun createWebView() {
        ...
        // === Captcha Debug: log WebView settings and request headers after creation ===
        webView?.let { wv ->
            fulguris.debug.CaptchaDebugLogger.logWebViewSettings(wv)
            fulguris.debug.CaptchaDebugLogger.logRequestHeaders(requestHeaders)
        }
    ...
    fun initializePreferences() {
        ...
        // === Captcha Debug: log headers after preference changes ===
        fulguris.debug.CaptchaDebugLogger.logRequestHeaders(requestHeaders)
    }
